    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold mb-4">
          ...
          <span>Comunidad Red Humana</span>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                Asocia tu correo para acceder al estado de tu membresía de socio dentro de Red Humana.
              </p>
              ...
              {user ? (
                ...
                <form onSubmit={handleStartCheckout} className="space-y-4 mb-6">
                  ...
                  <p className="text-xs text-slate-500">
                    ¿Ya tienes cuenta en Red Humana? <Link to="/login" className="text-emerald-600 font-semibold underline">Inicia sesión</Link>
                  </p>
                </form>
              )}
          ...
          <div>
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500">Completa tu suscripción directamente sin salir de Red Humana</p>
              </div>
              <button
                onClick={() => {
