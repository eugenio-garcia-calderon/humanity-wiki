...
const BLOQUES: { titulo: string; nota?: string; tareas: { texto: string; estado: Estado }[] }[] = [
  ...
  },
  {
    ...
    tareas: [
      ...
      { texto: 'Reparto mensual: construido. Al principio el bote es FIJO — 1.000 puntos al mes (decisión del 23-08-2026) — para arrancar y medir; después, el 50 % de la comisión. Mitad igual por cabeza, mitad por éxito; cada ejecución queda en el libro con el mes como entidad y no puede repetirse', estado: 'en_revision' },
