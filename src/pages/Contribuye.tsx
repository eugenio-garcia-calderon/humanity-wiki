    ...
    <div className="max-w-4xl mx-auto py-6 sm:py-10 px-4">
      ...
      <div className="text-center mb-10 sm:mb-14">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold mb-4">
          ...
          <span>Humanity.wiki de Bienestar Colectivo</span>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
              Humanity.wiki forma parte de la iniciativa de Light Humanity para garantizar el acceso a las necesidades humanas fundamentales en todos los territorios.
            </p>
          </div>
        </div>
      </div>
