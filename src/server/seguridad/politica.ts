...
const SIN_REVISAR: Entrada[] = [
  ...
  { m: 'POST', ruta: '/api/maps', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/graphs', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/graphs/:id', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/graphs/:id/layout', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'DELETE', ruta: '/api/graphs/:id/windows/:windowId', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/windows/:id/papelera', guardia: { tipo: 'revisar', detectado: 'admin+nivel' } },
  { m: 'POST', ruta: '/api/windows/:id/restaurar', guardia: { tipo: 'revisar', detectado: 'admin+nivel' } },
  { m: 'POST', ruta: '/api/knowledge/personal', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PATCH', ruta: '/api/publicaciones/:tipo/:id', guardia: { tipo: 'revisar', detectado: 'sesion' } },
  { m: 'DELETE', ruta: '/api/publicaciones/:tipo/:id', guardia: { tipo: 'revisar', detectado: 'sesion' } },
  { m: 'POST', ruta: '/api/publicaciones/:tipo/:id/restaurar', guardia: { tipo: 'revisar', detectado: 'sesion' } },
  { m: 'PUT', ruta: '/api/publicaciones/:tipo/:id/colaboradores', guardia: { tipo: 'revisar', detectado: 'sesion' } },
  { m: 'POST', ruta: '/api/carpetas', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/carpetas/:id', guardia: { tipo: 'revisar', detectado: 'admin+nivel' } },
  { m: 'DELETE', ruta: '/api/carpetas/:id', guardia: { tipo: 'revisar', detectado: 'admin+nivel' } },
  { m: 'PUT', ruta: '/api/publicaciones/:tipo/:id/carpetas', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/carpetas/auto-organizar', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/graphs/:id/windows', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/windows/:id', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/windows/:id/view', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/graphs/:id/entity-links', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/graphs/:id/edges', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'PUT', ruta: '/api/graphs/:id/edges/:edgeId', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/graphs/:id/edges/:edgeId/invertir', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'DELETE', ruta: '/api/graphs/:id/edges/:edgeId', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/rate', guardia: { tipo: 'revisar', detectado: 'nivel' } },
  { m: 'POST', ruta: '/api/comments', guardia: { tipo: 'revisar', detectado: 'nivel' } },
