...
export default function BarraDireccion({
  ...
  const boton = 'w-6 h-6 grid place-items-center rounded transition-colors shrink-0';

  return (
    <div className="flex items-center gap-1 px-2 py-1 border-b border-slate-200 bg-white shrink-0">
      ...
      <div className="flex-1 min-w-0 ml-1 px-2.5 py-1 rounded-full bg-slate-100 flex items-center gap-0.5 overflow-x-auto select-all">
