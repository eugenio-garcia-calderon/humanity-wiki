...
- **`llamadas.via` (migración 0083)**: cada llamada apunta por cuál de los tres caminos fue. No es telemetría por gusto: de los tres, uno se factura, y sin esto la primera noticia del gasto sería la factura. **No se guarda ninguna IP** — el tipo de camino, y nada más.
