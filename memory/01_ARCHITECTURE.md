...
- **Contextos de React** (`src/contexts/`): `AuthContext`, `DataContext`, `DesignContext`, `EditContext` — gestión de sesión, datos globales, tema/diseño editable en vivo (`admin/design`), y modo edición de contenido.
